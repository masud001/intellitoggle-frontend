<template>
	<!-- Hero Section -->
	<div class="header-section-background absolute top-0 left-0 w-full h-[682px] md:h-[720px] lg:h-[925px] xl:h-[1290px] 2xl:h-[1365px] bg-white" />
	<section class="hero-section">
		<div class="container-custom mx-auto z-10 flex items-center md:pt-[14px] pb-[42px] lg:pt-[64px] lg:pb-[69px] xl:pt-[154.2px] xl:pb-[141px]">
			<div class="hero-content mx-auto w-full mobile:w-[351px] lg:w-[1035px] xl:w-[1040px] text-center">
				<h1 class="capitalize font-satoshi text-white font-bold xs:text-[27px] sm:text-[33px] mobile:text-[34px] lg:text-[44px] leading-[1.3] md:leading-[1.6] lg:leading-[1.82] xl:leading-[1.3]   xl:text-[64px]  mb-[17px] lg:mb-[6px] xl:mb-[18px]">
					The First <span class="bg-[#f9a71e] px-[10px] py-[6px] md:py-[5px] xl:py-0 rounded-[8px]">
				...
				<p class="font-sans hidden lg:block  lg:text-[22px] md:font-bold xl:text-[32px] lg:font-semibold leading-[1.3] text-[#f9a71e] tracking-wide">
					...
					<div class="flex flex-col lg:flex-row gap-2 lg:gap-[24px] xl:gap-[32px] justify-center lg:items-end mt-[-7px] xl:ml-[17px] relative">
						<div class="flex-1 md:min-w-[243px] lg:min-w-[231px]  xl:min-w-[260px]">
							...
							<Button
								...
								text-class="font-sans font-semibold text-[14px] lg:text-[22px] xl:text-[24px] tracking-wide"
							>
								Get Access
							</Button>
						</div>
